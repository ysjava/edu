...
import com.sandgrains.edu.student.utils.base.BaseFragment;
...
public class SunUiUtil {
    private static Context context = EduStudentApplication.instance.getApplicationContext();
    ...
    static {
        // 注册系统字体变化监听
        EduStudentApplication.instance.registerComponentCallbacks(new ComponentCallbacks() {
            @Override
